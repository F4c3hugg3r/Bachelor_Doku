...
SCENARIOS = [
    {
        ...
        "cmd": "/home/lennard/Bachelor/SYN-Rust/target/release/mock_program_g_1"
    },
    {
        "name": "SYN-Rust (XDP, Copy)",
        "cmd": "/home/lennard/Bachelor/SYN-Rust/target/release/mock_program_c_1"
    },
     {
        "name": "SYN-Rust (XDP, Zero-Copy, kein RST)",
        "cmd": "/home/lennard/Bachelor/SYN-Rust/target/release/mock_program_zc_1"
    },
     {
        "name": "SYN-Rust (AF_PACKET)",
        "cmd": "/home/lennard/Bachelor/SYN-Rust/target/release/mock_program_afp_1"
    },
   {
       "name": "ZMap",
       "cmd": "zmap -q -p 80,443 -r 500000 -i enp6s0 -G 00:1b:21:da:fc:ef -S 192.168.0.0-192.168.0.63 -O csv -o output_results.csv --source-port 60000-60127 --dedup-method=window --dedup-window-size=1000000 1.0.0.0/10"
   },
    {
       "name": "Masscan (keine Duplikatsentfernung)",
       "cmd": "masscan 1.0.0.0/10 -p80,443 --rate 500000 -e enp6s0 --router-mac 00:1b:21:da:fc:ef --adapter-ip 192.168.0.0-192.168.0.63 -oL outpput_results.txt --source-port 60000-60127"
    }
]
# -----------------------------------------------------------------------------
