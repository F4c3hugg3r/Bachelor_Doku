...
SCENARIOS = [
    {
         ...
         "cmd": "/home/lennard/Bachelor/SYN-Rust/target/release/mock_program_g_2"
     },
     {
         "name": "SYN-Rust (XDP, Copy)",
         "cmd": "/home/lennard/Bachelor/SYN-Rust/target/release/mock_program_c_2"
     },
      {
         "name": "SYN-Rust (XDP, Zero-Copy)",
         "cmd": "/home/lennard/Bachelor/SYN-Rust/target/release/mock_program_zc_2"
     },
      {
         "name": "SYN-Rust (AF_PACKET, 2 Threads)",
         "cmd": "/home/lennard/Bachelor/SYN-Rust/target/release/mock_program_afp_2"
     },
    {
        "name": "ZMap",
        "cmd": "zmap -q -p 80 -B 1000M -T 2 -i enp6s0 -G 00:1b:21:da:fc:ef -S 192.168.0.0-192.168.0.63 -O csv -o output_results.csv --source-port 60000 1.0.0.0/6"
    },
     {
        "name": "Masscan",
        "cmd": "masscan 1.0.0.0/6 -p80 --rate 1500000 -e enp6s0 --router-mac 00:1b:21:da:fc:ef --adapter-ip 192.168.0.0-192.168.0.63 -oL outpput_results.txt --source-port 60000"
     }
]
# -----------------------------------------------------------------------------
